...
struct OnboardingFrameworkApp: App {
    let events: [Event] = [
        ...
        Event(title: "First step", description: "Time to start first step", userInteraction: .tap, entryAnimation: .easeInWithCircle, exitAnimation: .circleFadeOut, progress: 0),
